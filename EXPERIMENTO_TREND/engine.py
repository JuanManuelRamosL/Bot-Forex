"""
engine.py — Motor de simulación (copia recortada de BOT_FTMO/engine.py, mismas
fórmulas exactas de P&L/spread/riesgo/circuit breaker), pero solo instancia
TrendStrategy. Carpeta 100% aislada: no importa ni modifica nada de BOT_FTMO.
...
def simulate(cfg, times, highs, lows, closes, capital0=10000.0):
    ...
    start = max(cfg.ATR_PERIOD, cfg.ADX_PERIOD * 2 + 1, cfg.DONCHIAN_PERIOD) + 1
